<section class="discover-site-three-up fullwidth">
  <h2 class="discover-site-three-up-headline"><?php the_field('discover_section_title'); ?></h2>
  <div class="row">
    <div class="columns  medium-4 small-12">
      <img src="<?php the_field('marketing_icon'); ?>" alt="marketing">
      <h4 class="discover-site-three-up-title"><?php the_field('marketing'); ?></h4>
